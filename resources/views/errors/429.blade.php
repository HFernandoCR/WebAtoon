<x-app-layout>
    <div style="display: flex; align-items: center; justify-content: center; min-height: calc(100vh - 65px); background-color: #f3f4f6;">
        <div style="text-align: center; max-width: 600px; padding: 40px;">
            <div style="font-size: 120px; font-weight: bold; color: #e67e22; margin-bottom: 20px;">
                429
            </div>
            ...
            <p style="color: #7f8c8d; font-size: 1.1rem; margin-bottom: 30px;">
                Has realizado demasiadas solicitudes en poco tiempo. Por favor, espera un momento antes de intentar nuevamente.
            </p>
