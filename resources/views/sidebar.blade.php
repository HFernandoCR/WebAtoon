...
<aside id="sidebar-container"
    class="fixed inset-y-0 left-0 w-64 transform -translate-x-full md:translate-x-0 md:relative md:w-full h-full bg-slate-900 text-white flex flex-col p-6 overflow-hidden transition-transform duration-300 ease-in-out z-50 shadow-2xl md:shadow-none">
