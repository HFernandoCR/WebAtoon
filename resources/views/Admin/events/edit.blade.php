            ...
            <div
                ...
                <form action="{{ route('events.update', $event) }}" method="POST">
                    ...
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; margin-bottom: 8px; color: #555; font-weight: 600;">Nombre del
                    ...
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; margin-bottom: 8px; color: #555; font-weight: 600;">Categoría del
                            Evento</label>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                        <div>
                            <label style="display: block; margin-bottom: 8px; color: #555; font-weight: 600;">Fecha de
                                Inicio <span style="color:red">*</span></label>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                        <div>
                            <label style="display: block; margin-bottom: 8px; color: #555; font-weight: 600;">Ubicación
                                / Auditorio</label>
                            <input type="text" name="location" value="{{ old('location', $event->location) }}"
                                maxlength="255" placeholder="Ej: Auditorio Principal"
                                style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 5px; background: #f9fafb;">
                        </div>
                        <div>
                            <label style="display: block; margin-bottom: 8px; color: #555; font-weight: 600;">Estado del
                                Evento <span style="color:red">*</span></label>
                        ...
                        <div style="margin-bottom: 20px;">
                            <label style="display: block; margin-bottom: 8px; color: #555; font-weight: 600;">Encargado
                                del Evento <span style="color:red">*</span></label>
                    ...
                    <div style="margin-bottom: 30px;">
                        <label style="display: block; margin-bottom: 8px; color: #555; font-weight: 600;">Descripción
                            Detallada</label>
                    ...
                    <div style="display: flex; gap: 15px; border-top: 1px solid #eee; padding-top: 25px;">
                        <button type="submit"
                            style="background-color: #f39c12; color: white; padding: 12px 25px; border: none; border-radius: 5px; cursor: pointer; font-weight: bold; font-size: 1rem; transition: background 0.3s;">
                            Actualizar Evento
                        </button>
                        <a href="{{ route('events.index') }}"
                            style="background-color: #95a5a6; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 1rem; transition: background 0.3s;">
                            Cancelar
                        </a>
                    </div>
                </form>
