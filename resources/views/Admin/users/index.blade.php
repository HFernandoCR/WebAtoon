            ...
            <div
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <thead style="background-color: #f8f9fa; border-bottom: 2px solid #e9ecef;">
                        <tr>
                            <th style="padding: 15px; text-align: left; color: #6c757d; font-weight: 600;">Nombre</th>
                            <th style="padding: 15px; text-align: left; color: #6c757d; font-weight: 600;">Email</th>
                            <th style="padding: 15px; text-align: left; color: #6c757d; font-weight: 600;">Rol</th>
                            <th style="padding: 15px; text-align: left; color: #6c757d; font-weight: 600;">Institución
                            </th>
                            <th style="padding: 15px; text-align: center; color: #6c757d; font-weight: 600;">Acciones
                            </th>
                        </tr>
                    </thead>
                    <tbody>
