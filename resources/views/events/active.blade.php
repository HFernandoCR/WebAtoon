                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($events as $event)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm text-gray-500">{{ $event->category ? $event->category->name : 'General' }}</div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="text-sm text-gray-500 truncate max-w-xs" title="{{ $event->description }}">
                                                        {{ $event->description }}
                                                    </div>
                                                </td>
                                            </tr>
